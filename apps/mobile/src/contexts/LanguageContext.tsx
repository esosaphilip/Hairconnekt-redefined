...
export const TRANSLATIONS = {
  ...
  registerTermsPrefix: { de: 'Ich akzeptiere die', en: 'I accept the' },
  registerTermsTerms: { de: 'AGB', en: 'terms of use' },
  registerTermsConj: { de: 'und die', en: 'and the' },
  registerTermsPrivacy: { de: 'Datenschutzerklärung', en: 'privacy policy' },

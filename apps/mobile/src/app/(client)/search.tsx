...
const styles = StyleSheet.create({
  ...
  chip: { paddingHorizontal: spacing.md, paddingVertical: spacing.xs, borderRadius: borderRadius.full, borderWidth: spacing.unit, borderColor: colors.borderStrong, backgroundColor: colors.surface, marginRight: spacing.sm },
